...
public class GamePlayer {
	...
	/**
	 * The Player constructor has attributes for a name, starting location, inventory, score, and weapon.
	 */
  ...
  static void endGame(Player User) {
    System.out.println("Sorry, " + User.name + ". You have died. Game over.\n");
    TextAdventure.displayCredits();
    System.exit(0);
  }
  @Override
